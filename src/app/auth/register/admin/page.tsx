    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-2xl shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Complete this form to apply for an Administrator account. Your
            application requires approval. Already applied or have an account?{' '}
            <Link
        ...
        <CardContent className="pt-6">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <h3 className="text-lg font-medium pt-4 border-t dark:border-slate-700">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="123 Admin Way, Control City"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
