...
const patientRegistrationSchema = z
  .object({
    ...
    first_name: z
      .string()
      .min(1, { message: "First name is required." }), // Min 1 character
    last_name: z
      .string()
      .min(1, { message: "Last name is required." }), // Min 1 character
...
export default function PatientRegistrationPage() {
  ...
  async function onSubmit(data: PatientRegistrationFormValues) {
    ...
    setApiError(null);
    try {
      const { confirmPassword, first_name, last_name, phone_number, ...restOfData } = data;
      const payload: PatientRegistrationPayload = {
        ...restOfData,
        full_name: `${first_name} ${last_name}`,
        contact: phone_number || null, // API expects contact, can be null
      };
