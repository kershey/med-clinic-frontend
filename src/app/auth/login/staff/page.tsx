...
export default function StaffLoginPage() { // Renamed component
  ...
  async function onSubmit(data: LoginFormValues) {
    try {
      ...
      console.error("Staff login page submit error:", error);
    }
  }
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
        ...
        <Card className="w-full max-w-md shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Access the clinic management portal. Please use your provided credentials.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
